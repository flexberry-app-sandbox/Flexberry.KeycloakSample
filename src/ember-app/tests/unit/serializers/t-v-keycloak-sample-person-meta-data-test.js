...
moduleForModel('t-v-keycloak-sample-person-meta-data', 'Unit | Serializer | t-v-keycloak-sample-person-meta-data', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:t-v-keycloak-sample-person-meta-data',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
